	...
	return (
		<Router>
			<div className="grid grid-cols-12 h-screen bg-white">
			    <Menu className=" fixed z-50  sm:hidden flex items-center p-2 bg-gray-400 m-4 rounded-md" onClick={()=>setNavVis(!navVis)}/>
				<div className={`col-span-0 z-0  sm:col-span-1 ${navVis ? 'block absolute col-span-1' : 'hidden'} sm:block bg-white p-4`}>
					<NavBar /> 
				</div>		
				<div className={`col-span-11 sm:col-span-10 p-4 md:p-6 lg:p-8 bg-white `}>
					<Routes>
